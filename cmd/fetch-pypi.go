...
var pypiCmd = &cobra.Command{
	Use:   "pypi",
	Short: "Fetch the CVE information from osv-vulnerabilities/PyPI",
	Long:  `Fetch the CVE information from osv-vulnerabilities/PyPI`,
	RunE:  fetchPyPI,
}

func init() {
	fetchCmd.AddCommand(pypiCmd)
}

func fetchPyPI(cmd *cobra.Command, args []string) (err error) {
	...
	osvs, err := fetcher.FetchOSVDetails(models.PyPIType)
	if err != nil {
		return err
	}
